...
spawn(function() 
    ...
    wait(1.5)
    require(game.ReplicatedStorage.Notification).new("<Color=Red>Truong Hub chào ae<Color=/>"):Display()
    wait(.5)
    ...
    wait(.29)
    require(game.ReplicatedStorage.Notification).new("<Color=Yellow>nhớ tham gia discord trường Hub nhé<Color=/>"):Display()
    wait(.36)
end)

local OrionLib = loadstring(game:HttpGet(('https://raw.githubusercontent.com/shlexware/Orion/main/source')))()
local Window = OrionLib:MakeWindow({Name = "AnBaToCom Hub V1", HidePremium = false, IntroText = "Truong Hub⚜️", SaveConfig = true, ConfigFolder = "NightHub"})
...
W:AddLabel("TruongHub SCRIPT")
W:AddLabel("DiscordTruong Hub V1")
local Section = W:AddSection({
    Name = "Status"
})
